"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_score_score_module_ts"],{

/***/ 64949:
/*!***********************************************!*\
  !*** ./src/app/score/score-routing.module.ts ***!
  \***********************************************/
...
/* harmony import */ var _score_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./score.page */ 95903);
...
/* harmony import */ var _score_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./score-routing.module */ 64949);
/* harmony import */ var _score_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./score.page */ 95903);
...
/* harmony import */ var _score_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./score.page.html?ngResource */ 99578);
/* harmony import */ var _score_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./score.page.scss?ngResource */ 93047);
...
/* harmony import */ var _components_metronome_metronome_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/metronome/metronome.component */ 85942);
/* harmony import */ var _components_page_scale_page_scale_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/page-scale/page-scale.component */ 48597);
/* harmony import */ var _components_recording_recording_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/recording/recording.component */ 25490);
/* harmony import */ var _components_tuner_tuner_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/tuner/tuner.component */ 1344);
/* harmony import */ var _components_recordingConfirm_recording_confirm_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/recordingConfirm/recording-confirm.component */ 45661);
/* harmony import */ var _services_ensemble_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/ensemble.service */ 98293);
/* harmony import */ var _services_tools_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/tools.service */ 47526);
/* harmony import */ var tone__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tone */ 66151);
/* harmony import */ var howler__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! howler */ 71960);
...
/* harmony import */ var recordrtc__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! recordrtc */ 93197);
/* harmony import */ var recordrtc__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(recordrtc__WEBPACK_IMPORTED_MODULE_12__);
...
let ScorePage = class ScorePage {
    constructor(route, ensembleService, tools, popoverController, modalCtrl, modalCtrl2, domSanitizer) {
        this.route = route;
        ...
        this.countdownBegan = false; // flags that you want the countdown to start
        this.stopIn = 5000; // how long the timer should run
    ...
    ngOnInit() {
        ...
        if (this.selectedScore.type == "interactive") {
            ...
            const embed = new (flat_embed__WEBPACK_IMPORTED_MODULE_2___default())(container, {
                embedParams: {
                    appId: '62042cdc7544f10012e789e6',
    ...
    showMetornomeModal() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalCtrl.create({
                component: _components_metronome_metronome_component__WEBPACK_IMPORTED_MODULE_3__.MetronomeComponent,
    ...
    startMetronome(noOfBeats, beatValue) {
        tone__WEBPACK_IMPORTED_MODULE_10__.start();
        var barCount = 0;
        tone__WEBPACK_IMPORTED_MODULE_10__.Transport.bpm.value = 60;
        tone__WEBPACK_IMPORTED_MODULE_10__.Transport.start();
        ...
        tone__WEBPACK_IMPORTED_MODULE_10__.Transport.scheduleRepeat(function () {
            sound.play();
            barCount = barCount + 1;
            ...
            if (barCount == 1) {
                ...
                var firstBeat = new howler__WEBPACK_IMPORTED_MODULE_11__.Howl({
    ...
    stopMetronome() {
        tone__WEBPACK_IMPORTED_MODULE_10__.Transport.cancel();
        this.metronomeIsPlaying = false;
    }
    //tuner modal
    showTunerPopover(ev) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            const popover = yield this.popoverController.create({
                component: _components_tuner_tuner_component__WEBPACK_IMPORTED_MODULE_6__.TunerComponent,
    ...
    pageOptions(ev) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            const popover = yield this.popoverController.create({
                component: _components_page_scale_page_scale_component__WEBPACK_IMPORTED_MODULE_4__.PageScaleComponent,
            ...
            yield popover.onDidDismiss().then(res => this.ngOnDestroy(), error => console.log("Error: ", error));
        });
    }
    ...
    recordingModal() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalCtrl.create({
                component: _components_recording_recording_component__WEBPACK_IMPORTED_MODULE_5__.RecordingComponent,
    ...
    */
    successCallback(stream) {
        ...
        var StereoAudioRecorder = recordrtc__WEBPACK_IMPORTED_MODULE_12__.StereoAudioRecorder;
    ...
    */
    processRecording(blob) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.base64 = (yield this.blobToBase64(blob));
            // * saving recording *//
            //store recordingID
    ...
    */
    ...
    recordingconfirmModal() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__awaiter)(this, void 0, void 0, function* () {
            const modal = yield this.modalCtrl2.create({
                component: _components_recordingConfirm_recording_confirm_component__WEBPACK_IMPORTED_MODULE_7__.RecordingConfirmComponent,
...
ScorePage.ctorParameters = () => [
    ...
    { type: _services_ensemble_service__WEBPACK_IMPORTED_MODULE_8__.EnsembleService },
    { type: _services_tools_service__WEBPACK_IMPORTED_MODULE_9__.ToolsService },
...
ScorePage = (0,tslib__WEBPACK_IMPORTED_MODULE_13__.__decorate)([
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__; // Last time updated: 2021-03-09 3:20:22 AM UTC
// ________________
// RecordRTC v5.6.2
...
/***/ 93047:
/*!**************************************************!*\
  !*** ./src/app/score/score.page.scss?ngResource ***!
  \**************************************************/
/***/ ((module) => {

module.exports = "ion-content {\n  --padding-start: 0;\n  --padding-end: 0;\n}\n\n#sheetmusic {\n  height: 100%;\n}\n\nion-row {\n  position: relative;\n}\n\n#pageSelector {\n  position: absolute;\n  height: 100vh;\n  width: 100%;\n  z-index: 1000;\n}\n\n#pageSelector ion-col {\n  padding: 100% 0 100% 0;\n}\n\nion-tab-bar {\n  display: none !important;\n}\n\n#countdownNumber {\n  color: red;\n  display: inline-block;\n  font-weight: 500;\n}\n/*# sourceMappingURL=data:application/json;base64, */";

/***/ }),

/***/ 99578:
/*!**************************************************!*\
  !*** ./src/app/score/score.page.html?ngResource ***!
  \**************************************************/
/***/ ((module) => {

module.exports = "<ion-content [fullscreen]=\"true\">\r\n    \r\n  <div *ngIf=\"selectedScore.type == 'static'\" class=\"pdf-container\">\r\n    <div id=\"pageSelector\">\r\n      <ion-grid>\r\n        <ion-row>\r\n          <ion-col (click)=\"back();\" size=\"6\"></ion-col>\r\n          <ion-col (click)=\"forward();\" size=\"6\"></ion-col>\r\n        </ion-row>\r\n      </ion-grid>\r\n    </div>\r\n    \r\n    <pdf-viewer\r\n    [src]=\"pdfSrc\"\r\n    [rotation]=\"rotation\"\r\n    [original-size]=\"false\"\r\n    [show-all]=\"false\"\r\n    [fit-to-page]=\"false\"\r\n    [zoom]=\"zoom\"\r\n    [zoom-scale]=\"zoomScale\"\r\n    [stick-to-page]=\"false\"\r\n    [render-text]=\"true\"\r\n    [external-link-target]=\"'blank'\"\r\n    [autoresize]=\"true\"\r\n    [show-borders]=\"false\"\r\n    [page]=\"currentPage\"\r\n    (pages-initialized)=\"pageInitialized($event)\"\r\n    ></pdf-viewer>\r\n  </div>\r\n  \r\n  <div id=\"sheetmusic\"></div>\r\n  \r\n  \r\n</ion-content>\r\n\r\n<div #slideRuler></div>\r\n<div id=\"values\"></div>\r\n<div id=\"app\"></div>\r\n\r\n\r\n\r\n<ion-footer *ngIf=\"selectedScore.type =='interactive' \">\r\n  <ion-toolbar color=\"light\">   \r\n    <ion-row>\r\n      <ion-col [routerLink]=\"['/tabs','tab2',scoreID]\">\r\n        <span class=\"iconify\" data-icon=\"ic:baseline-home\"></span>\r\n      </ion-col>\r\n\r\n      <ion-col (click)=\"recordingModal();\">\r\n        <ion-icon name=\"mic\"></ion-icon>\r\n      </ion-col>\r\n\r\n      <ion-col (click)=\"showMetornomeModal();\">\r\n        <span class=\"iconify\" data-icon=\"mdi:metronome\"></span>\r\n      </ion-col>\r\n\r\n      <ion-col>\r\n        <ion-icon name=\"play-circle\"></ion-icon>\r\n      </ion-col>\r\n      \r\n      <ion-col>\r\n        <span class=\"iconify\" data-icon=\"mdi:brush\"></span>\r\n      </ion-col>\r\n            \r\n      <ion-col>\r\n        <ion-icon name=\"volume-medium\"></ion-icon>\r\n      </ion-col>     \r\n\r\n      <ion-col>\r\n        <ion-icon name=\"information-circle\"></ion-icon>\r\n      </ion-col>\r\n\r\n    </ion-row>\r\n\r\n  </ion-toolbar>\r\n</ion-footer>\r\n\r\n<ion-footer *ngIf=\"selectedScore.type =='static' \">\r\n  <ion-toolbar color=\"light\">   \r\n    <ion-row>\r\n      <ion-col [routerLink]=\"['/tabs','tab2',scoreID]\">\r\n        <span class=\"iconify\" data-icon=\"ic:baseline-home\"></span>\r\n      </ion-col>\r\n\r\n      <ion-col (click)=\"recordingModal();\"*ngIf=\"!isRecording\"> \r\n        <ion-icon name=\"mic\"></ion-icon>\r\n        <div *ngIf=\"timeTillStop > 0\" id=\"countdownNumber\">{{timeTillStop}}</div>\r\n      </ion-col>\r\n      \r\n      <ion-col id=\"stopButton\" *ngIf=\"isRecording\" (click)=\"stopRecording();\">\r\n        <ion-icon name=\"stop-circle\" color=\"danger\"></ion-icon>\r\n      </ion-col>\r\n\r\n\r\n      <ion-col (click)=\"showMetornomeModal();\">\r\n        <span class=\"iconify\" data-icon=\"mdi:metronome\"></span>\r\n      </ion-col>     \r\n            \r\n      <ion-col (click)=\"showTunerPopover($event);\">\r\n        <span class=\"iconify\" data-icon=\"arcticons:universal-tuner\"></span>\r\n      </ion-col>   \r\n\r\n      <ion-col (click)=\"pageOptions($event);\">\r\n        <ion-icon name=\"document\"></ion-icon>\r\n      </ion-col>\r\n\r\n      <ion-col>\r\n        <ion-icon name=\"information-circle\"></ion-icon>\r\n      </ion-col>\r\n\r\n    </ion-row>\r\n\r\n  </ion-toolbar>\r\n</ion-footer>\r\n\r\n\r\n\r\n";

/***/ })

}]);
//# sourceMappingURL=src_app_score_score_module_ts.js.map